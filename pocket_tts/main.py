...
def serve(
    ...
    language: Annotated[
        ...
        typer.Option(
            ...
            "'english_2026-01', 'english_2026-04', 'english_2026-09', 'english', 'french', 'french_24l', 'german', 'german_24l', 'portuguese', 'portuguese_24l', 'italian', 'italian_24l', 'spanish', 'spanish_24l', 'dutch', 'dutch_24l'."
